...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        delta_weights_i_h = np.zeros(self.weights_input_to_hidden.shape) # input to hidden
        delta_weights_h_o = np.zeros(self.weights_hidden_to_output.shape) # hidden to output
